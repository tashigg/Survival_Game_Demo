...
namespace SurvivalEngine
{
    ...
    public class PlayerCharacterAnim : MonoBehaviour
    {
        ...
        public void SetAnimBool(string id, bool value)
        {
            ...
            {
                character.character_animator.Animator.SetBool(id, value);
            }
        }
        ...
        {
            if (!string.IsNullOrEmpty(id))
                character.character_animator.Animator.SetFloat(id, value);
        }
        ...
        public void SetAnimTrigger(string id)
        {
            if (!string.IsNullOrEmpty(id))
            {
                character.character_animator.Animator.SetTrigger(id);
            }
        }
