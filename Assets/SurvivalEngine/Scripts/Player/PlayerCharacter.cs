...
namespace SurvivalEngine
{
    ...
    public class PlayerCharacter : MonoBehaviour
    {
        ...
        private NetworkBehaviour character_network;
        public ClientNetworkAnimator character_animator;
        ...
        public static PlayerCharacter player_first = null;
        private static List<PlayerCharacter> players_list = new List<PlayerCharacter>();

        public bool IsOwner => character_network.NetworkObject.IsOwner;
        ...
        void Awake()
        {
            ...
            character_network = GetComponent<NetworkBehaviour>();
            character_animator = GetComponentInChildren<ClientNetworkAnimator>();
        ...
        private void Start()
        {
            ...
            //     player_first = IsOwner ? this : null;
            ...
            // if (character_network.IsServer && LobbyManager.clientPlayer != null)
            // {
            //     Debug.Log($"{LobbyManager.clientPlayer.character_network.NetworkObjectId} - {NetworkManager.Singleton.LocalClientId}");

            //     LobbyManager.clientPlayer.character_network.NetworkObject.ChangeOwnership(LobbyManager.clientPlayer.character_network.NetworkObjectId);
            //     LobbyManager.clientPlayer.character_network.NetworkObject.ChangeOwnership(NetworkManager.Singleton.LocalClientId);
            // }



            // if (!character_network.IsOwner) return;
            // Debug.Log($"[{character_network.NetworkObject.GetInstanceID()}] {character_network.NetworkObject.IsLocalPlayer} - {character_network.NetworkObject.IsOwner}");
        ...
        void FixedUpdate()
        {
            ...
            // if (IsOwner)
            // {
            //     Debug.LogError(Quaternion.RotateTowards(rigid.rotation, targ_rot, rotate_speed * Time.fixedDeltaTime));
            // }
        ...
        {
            return move_enabled && controls_enabled && !IsDead() && !TheUI.Get().IsFullPanelOpened() && IsOwner;
        }
